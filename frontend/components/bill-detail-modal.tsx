      ...
      <div>
        ...
        <div className="flex flex-col gap-3">
          ...
          {isRejected
            ...
            : isVoided
              ? <><TimelineStep icon={CheckCircle} label="Approved" date={b.approvedAt} done color="#2F9E6E" /><TimelineStep icon={XCircle} label="Voided" date={b.approvedAt} done color="#888" /></>
