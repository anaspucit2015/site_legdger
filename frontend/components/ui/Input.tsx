...
const inputClass =
  'w-full border-[1.5px] border-[var(--border)] rounded-lg px-3 py-2.5 text-sm text-black bg-white outline-none transition-colors focus:border-[var(--navy)] placeholder:text-[var(--text-muted)] disabled:bg-[var(--bg)] disabled:text-[var(--text-muted)] disabled:cursor-not-allowed';
