...
export class BillsController {
  ...
  // ─── Admin: direct delete (pending, approved, or voided) ─────────────────
  @UseGuards(RolesGuard)
  @Roles('admin')
  @Delete(':id')
  adminDelete(@Param('id') id: string, @Req() req: any) {
    return this.billsService.adminDelete(id, req.user.id);
  }
  ...
  @Roles('admin')
  @Post(':id/void')
  voidBill(@Param('id') id: string, @Body() dto: VoidBillDto, @Req() req: any) {
    return this.billsService.void(id, dto, req.user.id);
  }
